...
public class MainActivity2 extends AppCompatActivity {
    ...
    private class EscutadorLista implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            Toast.makeText(MainActivity2.this, "Clique comum: " + textos.get(i),
        ...
        public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            Toast.makeText(MainActivity2.this, "Item apagado!", Toast.LENGTH_LONG).show();
